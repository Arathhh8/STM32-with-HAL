...
void HAL_WritePort(uint8_t data){
	...
	HAL_GPIO_WritePin(L2_GPIO_Port, L2_Pin, (((data & 0x02) >> 0) & 1));
	HAL_GPIO_WritePin(L3_GPIO_Port, L3_Pin, (((data & 0x04) >> 0) & 1));
	HAL_GPIO_WritePin(L4_GPIO_Port, L4_Pin, (((data & 0x08) >> 0) & 1));
}
